...
- Click the Explorer path field to type, a surrounding location to jump there, a preview to continue completing, or a directory, repository, or file entry to navigate to or open it.
